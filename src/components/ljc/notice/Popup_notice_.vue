          ...
          <div class="box2">
            ...
            <transition name="ani6">
              <div class="extendWin" @mousedown="onArea=true;" @mouseleave="onArea=false;leavefocus()" v-show="hrefOX">
                <div v-if="chosenFile.fileId" class="search-item opacity1">
                  <div class="item-box">
                  ...
                  <div class="btn3" @click="chosenFile.fileId=null">
                    删除
                  </div>
                </div>
                <div @click="hrefOX=false;chosenFile=Object.assign({},o);" v-show="o.fileId!=chosenFile.fileId" class="search-item pointer noSelect" v-for="(o,i) in assets" :key="o.fileId">
                  <div class="item-box">
...
import { alterNotice } from "@/api/notice.ts";
export default{
  name: 'Popup',
  props:{
    libraryFileId:{
